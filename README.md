Ce service de stockage et de gestion de fichiers est proposé sous forme d’une application web moderne (SPA, Responsive Design, etc.) offrant les fonctionnalités brièvement énumérées ci-dessous :
